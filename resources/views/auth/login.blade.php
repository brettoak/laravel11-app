        ...
        <x-slot name="logo">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex flex-col gap-4 mt-8">
                    ...
                    <button type="button" class="w-full flex justify-center items-center gap-2 py-3 px-4 border border-gray-200 rounded-xl shadow-sm text-sm font-semibold text-gray-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors cursor-pointer">
